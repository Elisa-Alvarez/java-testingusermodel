...
public class UserControllerTest
{
    ...
    public void getUserLikeName()throws Exception
    {
        ...
        Mockito.when(userService.findByNameContaining("barn")).thenReturn(newList);
    ...
    public void addNewUser()throws Exception
    {
        ...
        User nu = new User("mufasa", "simba", "lionking@disney.com");
        nu.setUserid(8675309);
    ...
    public void updateFullUser()throws Exception
    {
        ...
        User uu = new User("spongebob", "gary", "iamready@spongebob.com");
    ...
    public void updateUser()throws Exception
    {
        ...
        User uu = new User("atlas", "dog", "doggy@dogpaws.com");
        String u = mapper.writeValueAsString(uu);

        userList.get(3).setUsername("atlas");
